...
Thanks for using blob! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/blob/issues/new).
...
requests](https://github.com/batpigandme/blob/issues) to make sure the
